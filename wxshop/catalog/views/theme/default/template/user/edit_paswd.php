			...
			<div class="row">
				<div class="col-sm-12 panel panel-default middle-flat-left">
					<div class="panel-body">
						<form action="<?php echo site_url('user/edit/edit_paswd');?>" method="post" enctype="multipart/form-data" id="edit-paswd-form">
							<p class="text-center login-title"><strong>修改登陆密码</strong><hr style="margin: 10px 0">
							<div class="form-group">
								<input type="password" id="current_password" name="current_password" placeholder="当前密码" class="form-control" value=""/>
							</div> <!-- /field -->
							<div class="form-group">
								<input type="password" id="new_password" name="new_password" placeholder="新密码" class="form-control" value=""/>
							</div> <!-- /field -->
							<div class="form-group">
								<input type="password" id="confirm_password" name="confirm_password" placeholder="确认新密码" class="form-control" value=""/>
							</div> <!-- /field -->
