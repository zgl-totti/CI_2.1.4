...
<table class="table table-bordered table-hover user-wecome">
	...
	<tr>
		<td class="text-left col-sm-2 col-md-2"><a target="_blank" href="<?php echo site_url('product?product_id='.$order['products'][0]['product_id']);?>"><img width="<?php echo $this->config->get_config('wish_cart_image_size_b_w');?>px" height="<?php echo $this->config->get_config('wish_cart_image_size_b_h');?>px" class="media-object lazy" data-original="<?php echo $this->image_common->resize($order['products'][0]['image'], $this->config->get_config('wish_cart_image_size_b_w'), $this->config->get_config('wish_cart_image_size_b_h'));?>" alt="<?php echo $order['products'][0]['name']; ?>"></a></td>
		<td class="text-left col-sm-2 col-md-2"><span><a target="_blank" href="<?php echo site_url('product?product_id='.$order['products'][0]['product_id']);?>"><?php echo utf8_substr($order['products'][0]['name'], 0, 15); ?></a></span><br/><span class="value"><?php echo !empty($order['products'][0]['value']) ? utf8_substr($order['products'][0]['value'], 0, 15) : '';?></span></td>
	...
	<tr>
		<td class="text-left"><a target="_blank" href="<?php echo site_url('product?product_id='.$order['products'][$key]['product_id']);?>"><img width="<?php echo $this->config->get_config('wish_cart_image_size_b_w');?>px" height="<?php echo $this->config->get_config('wish_cart_image_size_b_h');?>px" class="media-object lazy" data-original="<?php echo $this->image_common->resize($order['products'][$key]['image'], $this->config->get_config('wish_cart_image_size_b_w'), $this->config->get_config('wish_cart_image_size_b_h'));?>" alt="<?php echo $order['products'][$key]['name']; ?>"></a></td>
		<td class="text-left"><span><a target="_blank" href="<?php echo site_url('product?product_id='.$order['products'][$key]['product_id']);?>"><?php echo utf8_substr($order['products'][$key]['name'], 0, 15); ?></a></span><br/><span class="value"><?php echo !empty($order['products'][$key]['value']) ? utf8_substr($order['products'][$key]['value'], 0, 15) : '';?></span></td>
