<li class="dropdown">
    ...
    <ul class="dropdown-menu cart-list">
		...
		<li ><a target="_blank" href="<?php echo site_url('user/cart');?>" class="text-center" style="padding-bottom: 0;padding-top: 0;border-bottom-width: 0"><?php echo lang_line('more');?></a></li>

		<?php endif;?>
		<li class="total">
            <span class="pull-right"><?php echo lang_line('count_price');?><?php echo $total;?></span>
            <a href="<?php echo site_url('user/cart');?>" class="btn btn-default btn-sm btn-cart" style="padding: 5px 15px"><?php echo lang_line('billing');?></a>
        </li>
		<?php else:?>
		<li><a><?php echo lang_line('empty_cart');?></a></a></li>
		<?php endif;?>
    </ul>
</li>