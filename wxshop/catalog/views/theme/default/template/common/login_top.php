<body id="<?php echo $css;?>">
								...
								<li>
									...
									<div class="col-menu col-md-3">
										...
										<ul class="menu-col">
											...
											<li>
												<a href="<?php site_url('product/category?id='.$category['category_id']);?>"><?php echo $category['name'];?></a>
											</li>
											<?php endforeach;?>
											<?php endif;?>
	...
	<div id="mobile-menu" class="well">
		<ul>
			...
			<li class="text-center" style="width: 20%"><a href="<?php echo site_url('common/mobile_nav');?>"><i class="glyphicon glyphicon-th-list"></i>管理</a></li>
			<li class="text-center" style="width: 20%"><a href="<?php echo site_url('user/wecome');?>"><i class="glyphicon glyphicon-user"></i>商家</a></li>
		</ul>
	</div>
