			...
			<div class="panel panel-default">
				<div class="panel-heading row row-panel-heading bg-info">
					...
					<div class="navbar-right btn-group" style="margin-right: 0">
						...
						<a href="<?php echo site_url('product/manufacturer');?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-share-alt"></i></a>
					</div>
				</div>
				<!-- /widget-header -->
				<div class="panel-body page-tab">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<a href="" id="thumb-image" data-toggle="admin-image" class="img-thumbnail"><img width="100px" height="100px" class="lazy" data-original="<?php echo isset($image) ? $image : $placeholder_image;?>" alt="分类图片" title="分类图片" data-placeholder="<?php echo $placeholder_image;?>" /></a>
