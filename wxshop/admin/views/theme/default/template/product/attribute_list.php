						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><a href="<?php echo site_url('product/attribute/edit_attribute?attribute_id='.$attribute['attribute_id'])?>#edit-attribute" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-edit"></i></a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><a href="<?php echo site_url('product/attribute/edit_attribute_group?attribute_group_id='.$attribute_group['attribute_group_id'])?>#edit-attribute-group" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-edit"></i></a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>
