		...
		<div class="col-md-12 middle-flat-left">
			<div class="panel panel-default">
				...
				<div class="panel-body page-tab">
					<form action="<?php echo $action;?>" method="post" enctype="multipart/form-data" id="form-barcode" class="form-horizontal">
						<div class="form-group" id="language">
							<label class="col-sm-2 control-label" for="barcode-name">条码名称</label>
							<div class="col-sm-10">
								...
								<div class="input-group">
								  ...
								  <input type="text" name="description[<?php echo $language['language_id']?>][name]" class="form-control" placeholder="条码名称" value="<?php echo isset($descriptions[$language['language_id']]['name']) ? $descriptions[$language['language_id']]['name'] : '';?>">
								</div>
								<?php endforeach;?>
							</div>
						</div>
