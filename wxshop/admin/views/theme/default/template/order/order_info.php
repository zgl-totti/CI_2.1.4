			...
			<?php if(!empty($orders)):?>
				...
				<table class="table" style="margin: 10px 0;border:1px solid rgb(217, 217, 217);">
					...
					<tbody>
						...
						<tr>
							<td class="col-md-1 col-sm-1 col-xs-2 text-left border-right"><a target="_blank" href="index.php/product.html?product_id=<?php echo $orders['products'][0]['product_id'];?>"><img width="<?php echo $this->config->get_config('wish_cart_image_size_b_w');?>px" height="<?php echo $this->config->get_config('wish_cart_image_size_b_h');?>px" class="media-object lazy" data-original="<?php echo $this->image_common->resize($orders['products'][0]['image'], $this->config->get_config('wish_cart_image_size_b_w'), $this->config->get_config('wish_cart_image_size_b_h'));?>" alt="<?php echo $orders['products'][0]['name']; ?>"></a></td>
							<td class="text-left col-md-3 col-sm-3 col-xs-4 border-right"><span><a target="_blank" href="index.php/product.html?product_id=<?php echo $orders['products'][0]['product_id'];?>"><?php echo $orders['products'][0]['name']; ?></a></span><span class="value"><?php echo !empty($orders['products'][0]['value']) ? $orders['products'][0]['value'] : '';?></span></td>
						...
						<tr>
							<td class="col-md-1 col-sm-1 col-xs-2 text-left border-right"><a target="_blank" href="index.php/product.html?product_id=<?php echo $orders['products'][$key]['product_id'];?>"><img width="<?php echo $this->config->get_config('wish_cart_image_size_b_w');?>px" height="<?php echo $this->config->get_config('wish_cart_image_size_b_h');?>px" class="media-object lazy" data-original="<?php echo $this->image_common->resize($orders['products'][$key]['image'], $this->config->get_config('wish_cart_image_size_b_w'), $this->config->get_config('wish_cart_image_size_b_h'));?>" alt="<?php echo $orders['products'][$key]['name']; ?>"></a></td>
							<td class="text-left col-md-3 col-sm-3 col-xs-4 border-right"><span><a target="_blank" href="index.php/product.html?product_id=<?php echo $orders['products'][$key]['product_id'];?>"><?php echo $orders['products'][$key]['name']; ?></a></span><span class="value"><?php echo !empty($orders['products'][$key]['value']) ? $orders['products'][$key]['value'] : '';?></span></td>
