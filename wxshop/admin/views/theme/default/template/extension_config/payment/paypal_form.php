			...
			<div class="panel panel-default">
				<div class="panel-heading row row-panel-heading bg-info">
					...
					<div class="navbar-right btn-group" style="margin-right: 0">
						...
						<a href="<?php echo site_url('extension_config/module/paypal');?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-share-alt"></i></a>
					</div>
				</div>
				<!-- /widget-header -->
				<div class="panel-body page-tab">
					<form action="<?php echo site_url('extension_config/payment/paypal');?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
