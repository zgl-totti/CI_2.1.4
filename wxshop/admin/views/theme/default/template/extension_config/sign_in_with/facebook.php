    ...
    <div class="col-md-12 middle-flat-left">
      <div class="panel panel-default">
        ...
        <div class="panel-body page-tab">
          <form action="<?php echo site_url('extension_config/sign_in_with/facebook/add');?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
			...
			<input name="image" type="hidden" value="facebook.jpg">
