    ...
    <div class="col-md-12 middle-flat-left">
      <div class="panel panel-default">
        <div class="panel-heading  row row-panel-heading bg-info">
	        <p class="navbar-left"><i class="glyphicon glyphicon-edit"></i>&nbsp;google登陆插件设置</p>
	    	<div class="navbar-right btn-group" style="margin-right: 0">
			  ...
			  <a href="<?php echo site_url('common/extension/sign_in_with');?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-share-alt"></i></a>
			</div>
        </div>
        <!-- /widget-header -->
        <div class="panel-body page-tab">
          <form action="<?php echo site_url('extension_config/sign_in_with/google/add');?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
			...
			<input name="image" type="hidden" value="google.jpg">
