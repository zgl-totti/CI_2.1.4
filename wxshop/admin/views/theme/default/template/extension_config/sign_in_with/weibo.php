    ...
    <div class="col-md-12 middle-flat-left">
      <div class="panel panel-default">
        <div class="panel-heading  row row-panel-heading bg-info">
	        <p class="navbar-left"><i class="glyphicon glyphicon-edit"></i>&nbsp;weibo登陆插件设置</p>
        ...
        <div class="panel-body page-tab">
          <form action="<?php echo site_url('extension_config/sign_in_with/weibo/add');?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
			...
			<input name="image" type="hidden" value="weibo.jpg">
