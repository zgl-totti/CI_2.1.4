      ...
      <div class="panel panel-default">
        <div class="panel-heading row row-panel-heading bg-info">
			...
			<div class="navbar-right btn-group" style="margin-right: 0">
				<a href="<?php echo site_url('localisation/aftermarket/add')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i></a>
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-right"><a href="<?php echo site_url('localisation/aftermarket/edit?aftermarket_id=').$aftermarket['aftermarket_id'];?>" class="btn btn-sm btn-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="编辑"><i class="glyphicon glyphicon-edit"></i></a></td>
					</tr>
					<?php endforeach;?>
					<?php endif;?>
				</tbody>
