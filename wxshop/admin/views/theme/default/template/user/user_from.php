...
<script type="text/javascript">
	function add_history()
	{
		$.ajax(
			{
				url: '<?php echo site_url();?>/user/user/add_history?user_id=<?php echo $user_id; ?>',
				type: 'post',
				dataType: 'html',
	...
	function add_transaction()
	{
		$.ajax(
			{
				url: '<?php echo site_url();?>/user/user/add_transaction?user_id=<?php echo $user_id; ?>',
				type: 'post',
				dataType: 'html',
	...
	function add_reward()
	{
		$.ajax(
			{
				url: '<?php echo site_url();?>/user/user/add_reward?user_id=<?php echo $user_id; ?>',
				type: 'post',
				dataType: 'html',
