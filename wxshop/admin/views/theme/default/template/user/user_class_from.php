      ...
      <div class="panel panel-default">
        ...
        <!-- /widget-header -->
            <div class="panel-body">
            	<form action="<?php echo $action;?>" method="post" enctype="multipart/form-data" id="form-user-class-edit" class="form-horizontal">
	            	...
	            	<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="user_class[level]" id="level" class="form-control" placeholder="多少分升级" value="<?php echo isset($level) ? $level : '0';?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="sort-order">排序</label>
						<div class="col-sm-10">
							<input type="text" name="user_class[sort_order]" class="form-control" id="" placeholder="排序" value="<?php echo isset($sort_order) ? $sort_order : '0';?>">
						</div>
					</div>
	            </div>
			</form>
