...
class Facebook extends MY_Controller {
	...
	public function __construct() {
		...
		if(!$this->user->hasPermission('access', 'admin/extension_config/sign_in_with/facebook')){
	...
	private function validateForm(){
		...
		if (!$this->user->hasPermission('modify', 'admin/extension_config/sign_in_with/facebook')) {
