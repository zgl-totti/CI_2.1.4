...
class Weibo extends MY_Controller {
	...
	{
		$this->document->setTitle('weibo登陆');
	...
	{
		$extension_setting=$this->sign_in_with_model->get_sign_with('sign_in_with', 'weibo');
		...
		$this->load->view('theme/default/template/extension_config/sign_in_with/weibo',$data);
	}
