...
class Attribute extends MY_Controller {
	...
	public function get_form()
	{
		...
		if($this->input->get('attribute_id')){
			$data['attribute_action']	=site_url('product/attribute/edit_attribute?attribute_id=').$this->input->get('attribute_id');
		}else{
			$data['attribute_action']	=site_url('product/attribute/add_attribute');
		}
		
		if($this->input->get('attribute_group_id')){
			$data['attribute_group_action']	=site_url('product/attribute/edit_attribute_group?attribute_group_id=').$this->input->get('attribute_group_id');
		}else{
			$data['attribute_group_action']	=site_url('product/attribute/add_attribute_group');
		}
	...
	public function get_list()
	{
		...
		//分页
		$config['base_url'] 			= site_url('product/attribute');
		$config['num_links'] 			= 2;
		...
		//分页
		$config1['base_url'] 			= site_url('product/attribute');
		$config1['num_links'] 			= 2;
		...
		$data['attribute_delete']		=site_url('product/attribute/delete_attribute');
		$data['attribute_group_delete']	=site_url('product/attribute/delete_attribute_group');
