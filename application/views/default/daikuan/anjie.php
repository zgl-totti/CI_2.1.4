...
<body>
	<div class="banner">
		<img src="<?php echo base_url('statics/images/gerenshangdai-banner.jpg');?>" width="100%" height="100%"/>
	</div>
	<div class="all clearfix">
		<img src="<?php echo base_url('statics/images/chanpinjianjie.jpg');?>" alt="" width="100%"/>
		<ul class="synopsis">
			<li>【产品定义】</li><p>巩义农商银行为购买商业用房的客户提供的定向消费贷款。</p>
			<li>【贷款条件】
				<ol>
					<li>具有完全民事行为能力的自然人，年龄在18（含）-60周岁（含）之间。</li>
					<li>具有合法有效的身份证明及婚姻状况证明。</li>
					<li>具有良好的信用记录和还款意愿。</li>
					<li>具有稳定的收入来源和按时足额偿还贷款本息的能力。</li>
					<li>具有所购商用房的销（预）售合同。</li>
					<li>购商用房的首付款或提供首付款证明。</li>
					<li>巩义农商银行规定的其他条件。</li>
				</ol>
			</li>
		</ul>
		...
		<ul class="synopsis">
			<li>【贷款资料】
				<ol>
					<li>借款人及关系人有效的身份证件、婚姻证明。</li>
					<li>借款人经济收入证明或职业证明。</li>
					<li>购房人合同。</li>
					<li>首付款发票或证明。</li>
					<li>巩义农商银行要求的其他资料。</li>
				</ol>
		...
		<ul class="synopsis">
			<li>【贷款额度、期限】</li><p>贷款额度最高为所购商用房价值的50% 。<br />期限最长不超过10年。</p>
		</ul>
	</div>
