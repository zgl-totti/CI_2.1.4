...
<body>
	...
	<div class="all">
		...
		<img style="margin-top: 0.1rem;" src="<?php echo base_url('statics/images1/pos_zixun-biao1.png');?>" alt="" class="biaodan" width="100%"/>
		...
		<p style="color: red;">1.标准价格特约商户</p><p>（除优惠类和减免类商户之外的商户）</p>
		...
		<p>金燕自助通各档次计费标准均为0.50%;</p>
		<p>2.非标准价格特约商户（优惠类和减免类商户）</p>
<p style="text-indent: 0.4rem;"><span style="display: inline-block;width: 0.12rem;height: 0.12rem;background-color:#e53936;border-radius: 50%;margin-right: 0.09rem;"></span>优惠类（大型超市门店数量达到20家（含）以上；公共缴费主要指水务、供电、燃气、供暖、废弃物处理等公共服务；加油类；交通运输类。）</p>
		<p class="paragraph"></p>
		<p>借记卡<br />
		日均存款低于50万元的借记卡刷卡费率按0.3%封顶15元计收手续费；日均存款高于50万元（含）的借记卡刷卡费率免收手续费。<br />
		贷记卡<br />
		金燕自助通各档次计费标准均为0.50%</p>
		<p class="paragraph"><span style="display: inline-block;width: 0.12rem;height: 0.12rem;background-color:#e53936;border-radius: 50%;margin-right: 0.09rem;"></span> 减免类：不计收手续费。（非营利医疗机构；非营利教育机构；慈善机构。）</p>
	
		<p style="color:#e53936;">(一)<span style="margin-left: 0.23rem;">规则</span></p>
