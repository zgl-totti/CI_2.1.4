...
<body>
<div class="contant">
  <div class="imgg-box"><img src="<?php echo base_url('statics/default/img/img/defalt.png');?>" alt=""></div>
  <p>请重试，<a href="<?php echo site_url("wxmain/lordsearch")?>"><span>点击这里</span></a></p>
</div>
