	...
	<style type="text/css">
		*{
		...
		.title1{
			...
			background: url(<?php echo base_url('statics/images/duihaunjilu_07.png')?>) no-repeat left center;
	...
	<ul class="beijing">
		...
		<li class="liebiao">
			<a href="#" class="containerr">
				...
				<p class="duihuan">兑换码： <span class="duihuanma"><?php echo $v['cdkey']?></span> </p>
				<div class="cgbz"><div class="chenggong">    <?php  echo  $v['status_user']==0? '未兑换' :'' ?></div><div class="shijian">交易时间：<span><?php echo   date('Y-m-d H:i:s',  $v['update_time'] )?></span></div></div>
			</a>
		</li>
		<?php }?>
	</ul>
