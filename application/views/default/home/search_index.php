			...
			<div class="overview" style=''>
				...
				<div >
					<form class="form-search" method='get' action="<?php echo site_url('home/search')?>">
						<input type="text" placeholder="医院编号、门诊号、住院号、患者姓名" name='search' class='homesearch' value='<?php echo $keywords;?>'/>
						...
						?>
						<input type="text" name='btimes' class='homesearchdate' value='<?php echo isset($btimes) && $btimes ? $btimes : $btime ;?>'/> - 
						<input type="text" name='etimes' class='homesearchdate' value='<?php echo isset($etimes) && $etimes ? $etimes : $etime;?>' />
