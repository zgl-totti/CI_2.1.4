...
* @param
*/
class Commodity_group_model extends CI_Model{
	public $CI;
	public $table_name	=	'';
	public function __construct(){
		...
		$this->table_name	=	$this->CI->db->dbprefix.'commodity_group';
	}
	...
	*/
	public function lists( $where = array() ){
		...
		//	列表信息
		$this->CI->db->select('id,name,parentid,listorder,display,content');
		if ( $where ) {
