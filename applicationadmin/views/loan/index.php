		...
		<div class="container-fluid">
			...
			<div class='row-fluid'>
				...
				<div class="input-append btn-group">
						<form class="form-inline" method='get' action="<?php echo site_url('loan/main/search');?>">
					...
					<div class="widget-box">
						<div class="widget-content nopadding">
							<form method="post" class="form-horizontal ui-formwizard" id="form-wizard" novalidate="novalidate" onsubmit="return CheckPost();" action="<?php echo site_url('loan/main/deletes')?>" >
								<table class="table table-bordered table-striped">
									...
									?>
										<tr>
										    ...
										    <td><?php echo $v['money'];?>　万元</td>

											<td>
												<?php echo date('Y-m-d  H:i:s', $v['addtime']);?>
											</td>

											<td><?php echo $v['status']==0?'未处理':'已处理';?></td>
											<td>
												<a href='<?php echo site_aurl('loan/main/edit/'.$v['id']);?>'>[修改]</a>
											</td>
										</tr>
									<?php
										}
