			...
			<div class='span12'>
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="<?php echo site_aurl('shops/group/add');?>" name="menuform" id="menuform" novalidate="novalidate" >
							...
							<div class="control-group">
								<label class="control-label">店面组名称</label>
								<div class="controls">
