...
<div id="content">
	<div id="content-header">
		<h1>店面服务管理</h1>
		<?php $this->load->view('shops/service/menu_top_nav');?> 
	</div>
			...
			<div class='span12'>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="<?php echo site_aurl('shops/service/edit');?>" name="menuform" id="menuform" novalidate="novalidate" >
							<input type='hidden' name='tableid' id='tableid' value='<?php echo $info["id"]?>' />
							
						
							<div class="control-group">
								<label class="control-label">店面服务名称</label>
								<div class="controls">
