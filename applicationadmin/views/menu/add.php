			...
			<div class='span12'>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="<?php echo site_aurl('system/menu/add');?>" name="menuform" id="menuform" novalidate="novalidate" >
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="language" name="language" />
									<span class="help-inline"></span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="m" name="m" />
									<span class="help-inline"></span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="c" name="c" />
									<span class="help-inline"></span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="a" name="a" />
									<span class="help-inline"></span>
								</div>
							</div>
