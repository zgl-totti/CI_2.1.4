...
<div id="content">
	<div id="content-header">
		<h1>地区管理</h1>
		<?php $this->load->view('region/menu_top_nav');?> 
	</div>
			...
			<div class='span12'>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form class="form-horizontal" method="post" action="<?php echo site_aurl('region/main/edit');?>" name="menuform" id="menuform" novalidate="novalidate" >
							...
							<div class="control-group">
								<label class="control-label">是否显示地区</label>
								<div class="controls">
