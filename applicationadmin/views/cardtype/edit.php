			...
			<div class='span12'>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<form class="form-horizontal" method="post" action="<?php echo site_aurl('cardtype/main/edit');?>" name="manageuserform" id="manageuserform" novalidate="novalidate"  enctype="multipart/form-data">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xxlarge" id="price" name="price" value="<?php echo $info['price'];?>"/>
								</div>
							</div>
