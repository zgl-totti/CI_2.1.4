			...
			<div class='row-fluid'>
				<div class='span12'>
					<div class="input-append btn-group">
						<form class="form-inline" method='get' action="<?php echo site_url('cardtype/main/search');?>">
			...
			<div class='row-fluid'>
				...
				<div class='span12'>
					...
					<div class="widget-box">
						...
						<form method="post" class="form-horizontal ui-formwizard" id="form-wizard" novalidate="novalidate" onsubmit="return CheckPost();" action="<?php echo site_url('cardtype/main/deletes')?>" >
							<table class="table table-bordered table-striped">
								...
								?>
									<tr>
										...
										<td>
											<a href='<?php echo site_aurl('cardtype/main/edit/'.$v['id']);?>'>[修改]</a>
										</td>
									</tr>
								<?php
									}
