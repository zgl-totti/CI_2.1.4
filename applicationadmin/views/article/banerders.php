                ...
                if(isset($info) && $info){
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo site_aurl('about/main/banerders');?>" name="manageuserform" id="manageuserform" novalidate="novalidate"  enctype="multipart/form-data">
