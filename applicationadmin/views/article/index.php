...
<?php $this->load->view('common/main_left_nav');?> 
	<div id="content">
		<div id="content-header">
			<h1>文章管理</h1>
			<?php $this->load->view('article/top_nav');?> 
		</div>
			...
			<div class='row-fluid'>
				<div class='span12'>
					...
					<div class="widget-box">
						...
						<form method="post" class="form-horizontal ui-formwizard" id="form-wizard" novalidate="novalidate" onsubmit="return CheckPost();" action="<?php echo site_url('about/article/deletes')?>" >
							<table class="table table-bordered table-striped">
								...
								?>
									<tr>
										...
										<td>
											<a href='<?php echo site_aurl('about/article/edit/'.$v['id']);?>'>[修改]</a>
										</td>
									</tr>
								<?php
									}
