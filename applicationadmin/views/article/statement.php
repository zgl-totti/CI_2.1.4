                ...
                if(isset($info) && $info){
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo site_aurl('about/main/statement');?>" name="manageuserform" id="manageuserform" novalidate="novalidate"  enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="input-xxlarge" type="text" name='authe' id='authe' placeholder="标题" value='<?php echo $info["authe"];?>'>
                                    </div>
                                </div>
                                <div class="control-group">
                               ...
                               <div class="control-group">
								...
								<div class="controls">
									<textarea rows="8" id="contentse" name="contentse" style='width:50%;' ><?php echo $info['contentse'];?></textarea>
								</div>
							</div>
