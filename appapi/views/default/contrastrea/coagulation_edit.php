	...
	<div class="dataview-board inline-box addpatients">
		<div class="inner">
			...
			<div class="item-list managepa">
				<form action="<?php echo site_url('contrastlab/editcoagulation')?>" method="post" id='formID'>
					...
					<table class='table-cont' width="100%">
						...
						<tr>
							<td>凝血酶原时间</td>
							<td>
								<input type='text' name='zymogen' placeholder="凝血酶原时间" data-errormessage-value-missing="凝血酶原时间" data-prompt-position="bottomLeft:3" autocomplete= "off" value='<?php echo $data['zymogen'];?>'/>
							</td>
						</tr>
						<tr>
							<td>部分凝血活酶时间</td>
							<td>
								<input type='text' name='part' placeholder="部分凝血活酶时间" data-errormessage-value-missing="部分凝血活酶时间" data-prompt-position="bottomLeft:3" autocomplete= "off" value='<?php echo $data['part'];?>'/>
							</td>
						</tr>
						<tr>
							<td>纤维蛋白原</td>
							<td>
								<input type='text' name='fibrin' placeholder="纤维蛋白原" data-errormessage-value-missing="纤维蛋白原" data-prompt-position="bottomLeft:3" autocomplete= "off" value='<?php echo $data['fibrin'];?>'/>
							</td>
						</tr>
						<tr>
							<td>凝血酶时间</td>
							<td>
								<input type='text' name='thrombin' placeholder="凝血酶时间" data-errormessage-value-missing="凝血酶时间" data-prompt-position="bottomLeft:3" autocomplete= "off" value='<?php echo $data['thrombin'];?>'/>
							</td>
						</tr>
						<tr>
							<td>发生ADR/ADE时</td>
