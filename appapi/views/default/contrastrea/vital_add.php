	...
	<div class="dataview-board inline-box addpatients">
		<div class="inner">
			...
			<div class="item-list managepa">
				<form action="<?php echo site_url('contrastlab/addvital')?>" method="post" id='formID'>
					...
					<table class='table-cont' width="100%">
						...
						<tr>
							<td>体温</td>
							<td>
								<input type='text' name='temperature' placeholder="体温" data-errormessage-value-missing="体温" data-prompt-position="bottomLeft:3" autocomplete= "off"/>
							</td>
						</tr>
						<tr>
							<td>脉搏（次/分）</td>
							<td>
								<input type='text' name='pulse' placeholder="脉搏" data-errormessage-value-missing="脉搏" data-prompt-position="bottomLeft:3" autocomplete= "off"/>
							</td>
						</tr>
						<tr>
							<td>呼吸（次/分）</td>
							<td>
								<input type='text' name='sreathing' placeholder="呼吸" data-errormessage-value-missing="呼吸" data-prompt-position="bottomLeft:3" autocomplete= "off"/>
							</td>
						</tr>
						<tr>
							<td>收缩压/舒张压（mmHg）</td>
							<td>
								<input type='text' name='systolic' placeholder="收缩压/舒张压" data-errormessage-value-missing="收缩压/舒张压" data-prompt-position="bottomLeft:3" autocomplete= "off"/>
							</td>
						</tr>
