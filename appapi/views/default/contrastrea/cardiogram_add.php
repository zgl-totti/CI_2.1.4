	...
	<div class="dataview-board inline-box addpatients">
		<div class="inner">
			...
			<div class="item-list managepa">
				<form action="<?php echo site_url('contrastlab/addcardiogram')?>" method="post" id='formID'>
					...
					<table class='table-cont' width="100%">
						...
						<tr>
							<td>结果</td>
							<td>
								<input type='text' name='result' placeholder="结果" data-errormessage-value-missing="结果" data-prompt-position="bottomLeft:3" autocomplete= "off"/>
							</td>
						</tr>
