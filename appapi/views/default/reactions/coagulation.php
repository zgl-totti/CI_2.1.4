	...
	<div class="dataview-board inline-box addpatients">
		<div class="inner">
			<div class="overview" style='position:relative;'>
				<p class="inline-block btn-border"><a href="<?php echo site_url('laboratory/addcoagulation')?>">新建</a> </p>
			</div>
			...
			<div class="item-list managepa">
					<table class='table-cont' width="100%">
						...
						<tr>
							...
							<td>
								<a href="<?php echo site_url('laboratory/editcoagulation/'.$v['id']);?>">查看</a>
							</td>
						</tr>
						<?php
							}
