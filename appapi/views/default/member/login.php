...
<div class="login">
	...
	<div class="form-panel">
		<form action="<?php echo site_url('login')?>" method="post" id='formID'>
			<input type="text" class="finput margin-auto btn-trans btn-large validate[required,minSize[3]]" placeholder="用户名/邮箱/手机号" id="username" data-errormessage-value-missing="请输入用户名"  data-prompt-position="bottomRight:3,-20" name='username' autocomplete= "off" />
