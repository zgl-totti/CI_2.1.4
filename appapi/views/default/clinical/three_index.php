	...
	<div class="dataview-board inline-box">
		<div class="inner">
			<div class="overview" style='position:relative;'>
				<p class="inline-block btn-border"><a href="<?php echo site_url('clinical/three_add')?>">新建病例</a> </p>
			</div>
				...
				<table class="table-cont" width="100%">
					...
					?>	
						<tr>
							...
							<td style="text-align:center;"><a href="<?php echo site_url('clinical/three_edit/'.$v['id']);?>">查看</a></td>
						</tr>
					<?php
						}
					?>	
